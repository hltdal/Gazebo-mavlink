...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.individual_arm_button = QtWidgets.QPushButton(Dialog)
        self.individual_arm_button.setObjectName("individual_arm_button")
        self.verticalLayout_4.addWidget(self.individual_arm_button, 0, QtCore.Qt.AlignHCenter)
        self.individual_force_arm_button = QtWidgets.QPushButton(Dialog)
        self.individual_force_arm_button.setObjectName("individual_force_arm_button")
        self.verticalLayout_4.addWidget(self.individual_force_arm_button, 0, QtCore.Qt.AlignHCenter)
        ...
        self.horizontalLayout_2.addWidget(self.individual_move_position_z_lineEdit, 0, QtCore.Qt.AlignHCenter)
        self.verticalLayout_3.addLayout(self.horizontalLayout_2)
        self.individual_move_velocity_lineEdit = QtWidgets.QLineEdit(Dialog)
        self.individual_move_velocity_lineEdit.setObjectName("individual_move_velocity_lineEdit")
        self.verticalLayout_3.addWidget(self.individual_move_velocity_lineEdit, 0, QtCore.Qt.AlignHCenter)
        self.verticalLayout_7.addLayout(self.verticalLayout_3)
        self.individual_move_button = QtWidgets.QPushButton(Dialog)
        self.individual_move_button.setObjectName("individual_move_button")
        self.verticalLayout_7.addWidget(self.individual_move_button, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Individual Drone Control Interface"))
        self.individual_arm_button.setText(_translate("Dialog", "Arm"))
        self.individual_force_arm_button.setText(_translate("Dialog", "Force Arm"))
        ...
        self.individual_move_velocity_lineEdit.setPlaceholderText(_translate("Dialog", "Velocity"))
        self.individual_move_button.setText(_translate("Dialog", "Move"))
